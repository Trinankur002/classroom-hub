  ...
  return (
    <Tabs value={view} onValueChange={(value) => onViewChange(value as SidebarView)} className="flex h-full flex-col">
      <TabsList className="grid h-11 w-full grid-cols-3 p-1">
        <TabsTrigger value="participants" className="px-2 text-sm">Participants</TabsTrigger>
        <TabsTrigger value="chat" className="px-2 text-sm">Chat</TabsTrigger>
        <TabsTrigger value="hands" className="px-2 text-sm">Hands</TabsTrigger>
      </TabsList>
        ...
        <ScrollArea className="h-full rounded-2xl border border-border/70 bg-card/80 p-3">
          <div className="space-y-3">
            <div className="flex items-center justify-between px-1">
              ...
              <div className="px-1">
                <Badge variant="noHoverDefault" className="px-2 py-0.5 text-xs font-semibold">
                  ...
                  <div key={participant.sid} className="rounded-xl border border-border/60 bg-background/70 p-3">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex shrink-0 items-center gap-1">
                        <span className="rounded-full bg-background px-1.5 py-1 text-[11px] text-muted-foreground">
